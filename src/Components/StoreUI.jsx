...
const PSStoreSidebarUI = () => {
  ...
  return (
    <div
      className="relative w-full bg-[#0a0e1a] text-white font-sans overflow-hidden"
    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          <div
            className={`absolute inset-0 bg-gradient-to-r ${games[currentIndex].color} via-black/20 to-transparent`}
          />
